    ...
    <div class="col-lg-6">
		<div class="jumbotron">
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="subcode">Tax Code</label>  
				  <div class="col-md-5">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="subdescription">Tax Description</label>  
				  <div class="col-md-5">
				...
				<div class="form-group"  align="right">
				  ...
				  <div class="col-md-5">
					<input type="submit" id="submit" name="submit" class="btn btn-primary" value="Add Tax"></input>
				  </div>
				</div>
