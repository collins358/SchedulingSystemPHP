...
<body>
 ...
 <br><div class="container"> 
  <div class="row" align="center">
    <div class="col-lg-6">
		<div class="jumbotron">
                Here you will Assign Organization
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="falname">Organization Name</label>  
				  <div class="col-md-5">
				...
				<div class="form-group"  align="right">
				  ...
				  <div class="col-md-5">
					<button id="submit" name="submit" class="btn btn-primary">Add Organization</button>
				  </div>
				</div>
